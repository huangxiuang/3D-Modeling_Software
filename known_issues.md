...
| ID | 标题 | 模块 | 严重程度 | 状态 |
|----|------|------|----------|------|
| ID-27 | 添加FlightPlotter时误吞ClickablePlotter鼠标事件方法 | 路径规划/3D交互 | 🔴 严重 | 已验证修复 |
...
| ID-27 | 误吞ClickablePlotter鼠标事件方法 | 3D交互 | 2026-07-03 | v1.7 |

### [ID-27] 添加FlightPlotter时误吞ClickablePlotter鼠标事件方法 ✅
